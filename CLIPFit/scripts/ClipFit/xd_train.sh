...
DATASET=${DATASET_ALL[10]}  #fgvc_aircraft
CFG='vit_b16_ep20'  # config file
...
for SEED in 1 2 3
do
    DIR=output/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp_lambda4_${CTP}/seed${SEED}
    if [ -d "$DIR" ]; then
